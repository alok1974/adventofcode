# day7
ips="""wysextplwqpvipxdv[srzvtwbfzqtspxnethm]syqbzgtboxxzpwr[kljvjjkjyojzrstfgrw]obdhcczonzvbfby[svotajtpttohxsh]cooktbyumlpxostt
...
def get_num_TLS(ips):
    num_TLS = 0
    for string in ips.split('\n'):
        seqs, hyper_seqs = get_parts(string)
...
print get_num_TLS(ips)
print get_num_SSL(ips)
